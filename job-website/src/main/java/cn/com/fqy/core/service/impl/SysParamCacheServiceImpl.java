...
import cn.com.fqy.core.dao.SysParamDao;
import cn.com.fqy.core.model.SysParam;
import cn.com.fqy.core.service.SysParamCacheService;
...
public class SysParamCacheServiceImpl implements SysParamCacheService {
	...
	private static final int DEFAULT_CACHE_UPDATE_INTERVAL_SEC = 180; //缓存更新的时间间隔的默认值（秒）
