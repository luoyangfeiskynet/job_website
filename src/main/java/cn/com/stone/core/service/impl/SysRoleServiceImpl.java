...
import cn.com.stone.core.dao.SysPermissionDao;
import cn.com.stone.core.dao.SysRoleDao;
import cn.com.stone.core.dao.SysRolePermRelDao;
import cn.com.stone.core.dao.SysUserRoleRelDao;
...
public class SysRoleServiceImpl implements SysRoleService{
	...
	public PageFinder<SysRole> pageList(Query q) {
		...
		sysRolePage.setPageSize(q.getPageSize());
		return sysRolePage;
	}
    ...
    public void addOrUpdateSysRole(SysRole sysRole)throws Exception {
    	try {
    		...
    		//权限树去重
    		Set<String> set = new HashSet<>(Arrays.asList(sysRole.getPermissionIds()));
    		List<String> ids = new ArrayList<String>(set);
    		//查询二级菜单集合中的父ID
